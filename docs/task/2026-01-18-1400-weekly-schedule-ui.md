...
- [x] 8.1. `page.tsx` でデータ取得ロジックを実装
- [x] 8.2. `listShiftsAction` で週のシフトを取得
- [x] 8.3. clients / staffs の名前解決データを取得
- [x] 8.4. Suspense でローディング状態を処理
- [x] 8.5. エラーハンドリングを実装

### ステップ9: 統合テストと仕上げ

- [x] 9.1. 全コンポーネントのテストが通ることを確認
- [x] 9.2. `pnpm test:ut --run` で全テストが成功することを確認
- [x] 9.3. Storybook で全状態を確認
- [x] 9.4. アクセシビリティチェック（label、フォーカス順序）
- [x] 9.5. レスポンシブ表示の確認
