...
#.devcontainer .env.local .git .github .gitignore .husky .next .pnpm-store .prettierignore .prettierrc .secrets .storybook .vscode CONTRIBUTING.md README.md docs eslint.config.mjs next-env.d.ts next.config.ts node_modules package.json pnpm-lock.yaml pnpm-workspace.yaml postcss.config.mjs public scripts src supabase test-data tsconfig.json tsconfig.tsbuildinfo vitest.config.mts vitest.setup.ts vitest.shims.d.ts /tmp/issue-35-spec.md /Tmp/tmp/issue-35-spec.md/tmp/issue-35-spec.md
/tmp/issue-35-spec.md
...
/tmp/issue-35-spec.md **A案（未割当も1列として表示し、さらに indicator バッジで目立たせる）** を一旦の前提とする。
