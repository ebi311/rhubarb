...
import type { ServiceUser, ServiceUserInput } from "@/models/serviceUser";
import type { ContractStatus } from "@/models/serviceUser";
...
export const ClientModal = (props: ClientModalProps) => {
  ...
  const contractStatus = watch("contract_status") ?? "active";
